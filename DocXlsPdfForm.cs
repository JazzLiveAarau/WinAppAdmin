...
{
    /// <summary>Download and upload of a xls jazz document
    /// <para>This dialog is for any xls document with a PDF copy.</para>
    /// <para></para>
    /// <para></para>
    /// <para>How to add this kind of document class is described in JAZZ_live_AARAU_Admin_Doc.rtf</para>
    /// </summary>
    public partial class DocXlsPdfForm : Form
    {
        ...
        public DocXlsPdfForm(DocAdminForm i_doc_admin_form, DocExeDocument i_doc_exe_document)
        {
            InitializeComponent();
        ...
        private void _SetTexts()
        {
            ...
            m_text_box_file_name_xls.Text = m_doc_exe_document.GetFileNameXls();
            m_text_box_file_name_pdf.Text = m_doc_exe_document.GetFileNamePdf();

            if (m_doc_exe_document.GetFileType().Equals("concert"))
            {
                //QQQQ m_text_box_concert_name.Text = DocAdmin.GetCurrentBandName();
        ...
        private void _SetToolTips()
        {
            ...
            ToolTipDownLoadXls.SetToolTip(m_button_download_xls, DocAdminString.ToolTipDownLoadXls);
            ToolTipUtil.SetDelays(ref ToolTipDownLoadXls);
            ...
            ToolTipUpLoadXls.SetToolTip(m_button_upload_xls, DocAdminString.ToolTipUpLoadXls);
            ToolTipUtil.SetDelays(ref ToolTipUpLoadXls);
            ...
            ToolTipDeleteXls.SetToolTip(m_button_delete_xls, DocAdminString.ToolTipDeleteXls);
            ToolTipUtil.SetDelays(ref ToolTipDeleteXls);
            ...
            ToolTipFilenameXls.SetToolTip(m_text_box_file_name_xls, DocAdminString.ToolTipFilenameXls);
            ToolTipUtil.SetDelays(ref ToolTipFilenameXls);
        ...
        /// <summary>User clicked button download xls</summary>
        private void m_button_download_xls_Click(object sender, EventArgs e)
        {
            if (!m_doc_exe_document.ExeDownloadClick("xls", "main", m_textbox_message))
                return;

        } // m_button_download_xls_Click
        ...
        /// <summary>User clicked button upload xls</summary>
        private void m_button_upload_xls_Click(object sender, EventArgs e)
        {
            bool admin_file = false; 
            if (!m_doc_exe_document.ExeUploadClick("xls", "main", admin_file, m_editable, m_text_box_file_name_xls, m_textbox_message))
                return;

        } // m_button_upload_xls_Click
        ...
        /// <summary>User clicked button delete xls</summary>
        private void m_button_delete_xls_Click(object sender, EventArgs e)
        {
            if (!m_doc_exe_document.ExeDeleteClick("xls", m_editable, m_text_box_file_name_xls, m_textbox_message))
                return;
        }
