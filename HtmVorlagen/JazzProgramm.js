...
// The windows application JAZZ live AARAU Admin adds the content.
//
// Remark:
// It is necessary that the objects with the concert data and these functions,
// using the oobjects, are in the same file. It works with separate files
...
function ConcertDayDateTime(i_day_name, i_concert_year, i_concert_month, i_concert_day, i_start_hour, i_start_minute)
{
	...
	ret_str = ret_str + i_concert_day + "/" + i_concert_month + "<br>";
...
// Returns a string with a link to more information about the concert
